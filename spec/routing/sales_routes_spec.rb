...
RSpec.describe 'Sales Controller', type: :routing do
  ...
  it { expect(get: sale_path(id: 1)).not_to route_to('sales#show', id: '1') }
  ...
  it { expect(patch: sale_path(id: 1)).not_to route_to('sales#update', id: '1') }

  it { expect(put: sale_path(id: 1)).not_to route_to('sales#update', id: '1') }
